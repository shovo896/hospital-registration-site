...
function initializeSampleData() {
    ...
    hospitalData.alerts = [
        { id: 'AL001', title: 'Spring Wellness Fair', message: 'Free basic checkup and floral therapy corner on Friday.', type: 'info', time: new Date().toISOString() },
        { id: 'AL002', title: 'Blood Drive Bonus', message: 'Rose badge for all O+ donors this week.', type: 'success', time: new Date().toISOString() },
        { id: 'AL003', title: 'Maintenance', message: 'MRI wing repainting tonight; expect minor delays.', type: 'warning', time: new Date().toISOString() }
    ];
    saveData();
}
